...
export default function Home() {
  ...
  return (
    ...
    <header>
      ...
      <span>Family,Code,Roll, Run ,Repeat</span>
      <MenuBtn/>
      </div>
    </header>
    ...
    <main>
      ...
      <span className=' about-me'>I’m Jesper, 28-year-old aspiring JavaScript developer based in Kristinehamn, Värmland.
...
I love building clean, functional, user-friendly apps—and I’m always hungry to learn more.</span>
...
<button>Portfolie</button>
    ...
    <img className='footer-social' onClick={() => window.location.href ="mailto: Jesperpersson96@hotmail.se"} src="/src/assets/email.png" alt="email icon" />
